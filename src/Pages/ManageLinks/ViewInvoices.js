    ...
    <TopHeadingProvider>
      <div className="p-4 sm:p-7">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          ...
          {/* Approved */}
          <div className="bg-[#3FC28A0D] border-1 border-[#3FC28A] rounded-xl p-4 sm:p-6 h-[100px] sm:h-[120px] flex items-start">
            <div className="bg-[#3FC28A0D] p-2 sm:p-[10px] rounded-lg mr-3 sm:mr-4 flex-shrink-0 -mt-1 sm:-mt-2">
              <svg className="w-6 h-6 sm:w-10 sm:h-10" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="20" cy="27.4987" rx="10" ry="4.16667" stroke="#3FC28A" strokeWidth="3" strokeLinejoin="round" />
                <ellipse cx="20" cy="13.332" rx="5" ry="5" stroke="#3FC28A" strokeWidth="3" strokeLinejoin="round" />
            ...
            <div className="flex flex-col justify-center -mt-1">
              <div className="text-xs sm:text-sm text-[#16151C] font-light">Approved</div>
              <div className="text-xs sm:text-sm text-[#16151C] font-light mb-1">Earnings</div>
              <div className="text-xl sm:text-2xl font-semibold text-[#3FC28A]">
          ...
          {/* This Month */}
          <div className="bg-[#00B8E20D] border-1 border-[#00B8E2] rounded-xl p-4 sm:p-6 h-[100px] sm:h-[120px] flex items-start">
            <div className="bg-[#00B8E20D] p-2 sm:p-[10px] rounded-lg mr-3 sm:mr-4 flex-shrink-0 -mt-1 sm:-mt-2">
              <svg className="w-6 h-6 sm:w-10 sm:h-10" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="20" cy="27.4987" rx="10" ry="4.16667" stroke="#00B8E2" strokeWidth="3" strokeLinejoin="round" />
                <ellipse cx="20" cy="13.332" rx="5" ry="5" stroke="#00B8E2" strokeWidth="3" strokeLinejoin="round" />
            ...
            <div className="flex flex-col justify-center -mt-1">
              <div className="text-xs sm:text-sm text-[#16151C] font-light">This Month</div>
              <div className="text-xs sm:text-sm text-[#16151C] font-light mb-1">Earnings</div>
              <div className="text-xl sm:text-2xl font-semibold text-[#00B8E2]">
          ...
          {/* Total */}
          <div className="bg-[#4071B60D] border-1 border-[#4071B6] rounded-xl p-4 sm:p-6 h-[100px] sm:h-[120px] flex items-start">
            <div className="bg-[#4071B60D] p-2 sm:p-[10px] rounded-lg mr-3 sm:mr-4 flex-shrink-0 -mt-1 sm:-mt-2">
              <svg className="w-6 h-6 sm:w-10 sm:h-10" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="20" cy="27.4987" rx="10" ry="4.16667" stroke="#4071B6" strokeWidth="3" strokeLinejoin="round" />
                <ellipse cx="20" cy="13.332" rx="5" ry="5" stroke="#4071B6" strokeWidth="3" strokeLinejoin="round" />
            ...
            <div className="flex flex-col justify-center -mt-1">
              <div className="text-xs sm:text-sm text-[#16151C] font-light">Total</div>
              <div className="text-xs sm:text-sm text-[#16151C] font-light mb-1">Earnings</div>
              <div className="text-xl sm:text-2xl font-semibold text-[#4071B6]">
        ...
        {/* Accordion Section */}
        <div className="border border-[#A2A1A833] rounded-[10px] p-4 sm:p-6">
          <div className="space-y-3 sm:space-y-4">
            {paginatedResults.map((item, index) => (
              ...
              >
                <AccordionSummary
                  expandIcon={<ExpandMoreIcon fontSize="inherit" className="ml-1 !text-2xl sm:!text-3xl text-[#16151C]" />}
                ...
                >
                  <div className="flex flex-col sm:flex-row w-full justify-between items-start sm:items-center gap-2 sm:gap-0">
                    <div className="text-base sm:text-lg font-light text-[#16151C]">
                      {months[item?.month - 1]} {item?.year} View Details
                    </div>
                    <div className="text-xl sm:text-2xl font-semibold text-[#16151C]">
                      $ {calculateMonthlyInvoice(invoices, item?.month, item?.year).toFixed(2)}
                    </div>
                  </div>
                </AccordionSummary>
                <AccordionDetails className="px-0 pb-3 sm:pb-4 pt-0">
                  <div className="space-y-3 sm:space-y-4">
                    {provideMonthlyInvoice(invoices, item?.month, item?.year).map((invoice, idx) => (
                      <div
                        key={idx}
                        className={`p-3 sm:p-4 pb-1 border-top border-gray-200 ${idx !== 0 ? "mt-3 sm:mt-4" : ""}`}
                      >
                        <div className="flex flex-col sm:flex-row w-full gap-3 sm:gap-0">
                          ...
                          <div className="flex-1 sm:ml-4">
                            <div className="font-semibold text-[14px] sm:text-[16px] text-[#16151C] mb-2">{invoice?.subject}</div>

                            <div className="flex flex-col text-[12px] sm:text-[14px] text-[#16151C] space-y-1">
                              <div className="flex flex-col sm:flex-row">
                                <span className="font-light w-28 sm:w-40 mb-1 sm:mb-0">Tutor Name:</span>
                                <span className="font-medium">{invoice?.teacherName || "N/A"}</span>
                              </div>
                              <div className="flex flex-col sm:flex-row">
                                <span className="font-light w-28 sm:w-40 mb-1 sm:mb-0">Remarks:</span>
                                <span className="font-medium">{invoice?.teacherReview || "N/A"}</span>
                              </div>
                              <div className="flex flex-col sm:flex-row">
                                <span className="font-light w-28 sm:w-40 mb-1 sm:mb-0">Student Remarks:</span>
                          ...
                          <div className="flex flex-row sm:flex-col justify-between items-start sm:items-end flex-shrink-0 sm:ml-6 mt-2 sm:mt-0 gap-2 sm:gap-0">
                            <div className="text-left sm:text-right">
                              <div className={`text-[16px] sm:text-[18px] font-semibold ${invoice?.status === "Pending" ? "text-[#F49342]" : "text-[#3FC28A]"}`}>
                                $ {Number.parseFloat(invoice?.sessionInfo?.tutorHourlyRate || 0).toFixed(2)}
                              </div>
                              <div className="text-[12px] sm:text-[14px] font-light text-[#A2A1A8]">
                                {invoice?.sessionInfo?.date} ({convertToAMPM(invoice?.sessionInfo?.time)})
                              </div>
                            </div>

                            {invoice?.status === "Pending" ? (
                              <div className="flex items-center gap-1 sm:gap-2 text-[#F49342] py-1 rounded-full text-[12px] sm:text-[14px] font-semibold">
                                <svg className="w-4 h-4 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12" stroke="#F49342" strokeWidth="1.5" strokeLinecap="round" />
                                  <path d="M12 22C6.47715 22 2 17.5228 2 12" stroke="#F49342" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="0.5 3" />
                                  <path d="M13.5 12C13.5 12.8284 12.8284 13.5 12 13.5C11.1716 13.5 10.5 12.8284 10.5 12C10.5 11.1716 11.1716 10.5 12 10.5C12.8284 10.5 13.5 11.1716 13.5 12Z" stroke="#F49342" strokeWidth="1.5" />
                                  <path d="M12 13.5L12 16M6 12L10.5 12" stroke="#F49342" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                Pending
                              </div>
                            ) : (
                              <div className="flex items-center gap-1 sm:gap-2 text-[#3FC28A] py-1 rounded-full text-[12px] sm:text-[14px] font-semibold">
                                <svg className="w-4 h-4 sm:w-6 sm:h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M17 3.33782C15.5291 2.48697 13.8214 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 10.7687 21.7775 9.58934 21.3704 8.5M7 10L10.5264 12.8211C11.3537 13.483 12.5536 13.3848 13.2624 12.5973L21 4" stroke="#3FC28A" strokeWidth="1.5" strokeLinecap="round" />
                                </svg>
                                Approved
                              </div>
                            )}
            ...
            {result?.length === 0 && (
              <div className="bg-white rounded-xl p-6 sm:p-12 text-center shadow-sm border border-gray-200">
                <div className="text-lg sm:text-2xl text-gray-400">No Earnings Yet</div>
              </div>
            )}

            {/* Pagination Controls */}
            {totalPages > 1 && (
              <div className="flex flex-col sm:flex-row items-center justify-between mt-4 sm:mt-6 py-3 bg-white gap-3 sm:gap-0">
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  {/* Page numbers */}
                  {getVisiblePages(currentPage, totalPages, 4).map((page) => (
                    <Button
                      key={page}
