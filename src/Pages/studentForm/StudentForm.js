...
import "./StudentForm.css"; // make sure to create this file
...
useEffect(() => {
  ...
  return (
    <div style={{ marginBottom: "20px" }}>
      <TopHeading>Student Forms</TopHeading>
            ...
            >
              ...
              <AccordionDetails>
                ...
                <div>
                {
                  ...
                  <div><strong>Selected Subjects:</strong> {student.selectedSubjects.length ? student.selectedSubjects.join(", ") : "None"}</div>
                  ...
                  <div><strong>Lesson Dates:</strong> <br/><ul>{student.lessonDates?.map((item, index) => <li key={index}>{item}</li>)}</ul></div>
                  ...
                  {student.guidanceAndSupport?.needed && (
                    <div style={{ borderTop: '1px solid #ccc', marginTop: '1rem', paddingTop: '1rem' }}>
                      <strong>Guidance & Support Details:</strong><br />
                      <div><strong>Assignment Type(s):</strong> {student.guidanceAndSupport.assignmentType.length ? student.guidanceAndSupport.assignmentType.join(", ") : "None"}</div>
                      <div><strong>Query:</strong> {student.guidanceAndSupport.query || "N/A"}</div>
                      <div><strong>Requested Hours:</strong> {student.guidanceAndSupport.hours}</div>
                    </div>
                  )}
                
                  <div style={{ borderTop: '1px solid #ccc', marginTop: '1rem', paddingTop: '1rem' }}>
                    <strong>Student Info:</strong><br />
                    {student?.userDetails?.firstName} {student?.userDetails?.lastName}<br />
                    Email: {student?.userDetails?.email}
                  </div>
                
                  <div style={{ borderTop: '1px solid #ccc', marginTop: '1rem', paddingTop: '1rem' }}>
                    <strong>Parent Info:</strong><br />
                    {student?.userDetails?.parentFirstName} {student?.userDetails?.parentLastName}<br />
                    Email: {student?.userDetails?.parentEmail}<br />
                    Relation: {student?.userDetails?.relation}
                  </div>
                
                  <div style={{ borderTop: '1px solid #ccc', marginTop: '1rem', paddingTop: '1rem' }}>
                    <strong>Billing Info:</strong><br />
                    Name: {student?.billingInfo?.fullName}<br />
                    Email: {student?.billingInfo?.email}<br />
...
:
          ...
          <h3>Guidance and Support Form:</h3>
                  ...
                  <div>
                      <strong>Submission User Type:</strong>{" "}
                      {student?.userType}
                    </div>
                    <div>
...
{/* GUIDANCE AND SUPPORT */}
                ...
                </div>
                {
                  ...
                  <div>
                      ...
                      <ul>
                        {student?.guidanceAndSupportSubjects?.map((item, index) => (
                          <li key={index}>{item}</li>
                        ))}
                      </ul>
                    </div>
