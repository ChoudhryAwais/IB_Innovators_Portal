  ...
  const tabConfig = [
      ...
      activeIcon: (
        <svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M7 8C9.20914 8 11 6.20914 11 4C11 1.79086 
            9.20914 0 7 0C4.79086 0 3 1.79086 3 4C3 6.20914 
            4.79086 8 7 8ZM7 18C10.866 18 14 16.2091 14 14C14 
            11.7909 10.866 10 7 10C3.13401 10 0 11.7909 0 14C0 
            16.2091 3.13401 18 7 18Z"
            fill="#4071B6"
          />
        </svg>
      ),
    },
    {
      ...
      inactiveIcon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M4 6C4 3.79086 5.79086 2 8 2H15.3431C16.404 2 
            17.4214 2.42143 18.1716 3.17157L20.8284 
            5.82843C21.5786 6.57857 22 7.59599 22 
            8.65685V18C22 20.2091 20.2091 22 18 
            22H8C5.79086 22 4 20.2091 4 18V6Z"
            stroke="#16151C"
            strokeWidth="1.5"
            strokeLinejoin="round"
          />
          <path d="M9 7H17" stroke="#16151C" strokeWidth="1.5" strokeLinecap="round" />
      ...
      activeIcon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M4 6C4 3.79086 5.79086 2 8 2H15.3431C16.404 
            2 17.4214 2.42143 18.1716 3.17157L20.8284 
            5.82843C21.5786 6.57857 22 7.59599 22 
            8.65685V18C22 20.2091 20.2091 22 18 
            22H8C5.79086 22 4 20.2091 4 18V6Z"
            fill="#4071B6"
            ...
            strokeLinejoin="round"
          />
          <path d="M9 7H17" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
    ...
    },
    {
      ...
      inactiveIcon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M2.5 12.7139C3.83758 13.3527 6.26401 14.2167 10.0029 14.5322C10.0357 15.6081 10.9162 16.4707 12 16.4707C13.0451 16.4707 13.9009 15.6685 13.9902 14.6465C17.7159 14.445 20.1498 13.515 21.5 12.8008V18.375C21.5 20.308 19.933 21.875 18 21.875H6C4.067 21.875 2.5 20.308 2.5 18.375V12.7139ZM6 6.875H18C19.8575 6.875 21.3754 8.32211 21.4912 10.1504C21.4298 10.1989 21.3513 10.2602 21.2529 10.3291C20.9633 10.5319 20.5093 10.8117 19.8721 11.1016C18.6312 11.6659 16.6857 12.2699 13.8877 12.4131C13.6156 11.6317 12.8745 11.0703 12 11.0703C11.1533 11.0703 10.4318 11.5966 10.1396 12.3389C7.32346 12.1003 5.36522 11.5099 4.11523 10.9824C3.47392 10.7117 3.01779 10.4572 2.72656 10.2744C2.63912 10.2195 2.56806 10.1684 2.50977 10.1279C2.63657 8.31026 4.1501 6.875 6 6.875Z" stroke="#16151C" stroke-linecap="round" />
