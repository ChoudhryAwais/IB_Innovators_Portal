...
const UpcomingCourseForm = () => {
  ...
  const totalPages = Math.ceil(contactUsSubmissions?.length / itemsPerPage);
  ...
  return (
    <div className="min-h-screen">
      ...
      {showModal && selectedLink && (
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between px-4 py-3 bg-white">
          {/* Showing records info */}
          <div className="text-sm text-gray-700 mb-3 sm:mb-0">
            Showing {startIndex + 1} to {Math.min(endIndex, contactUsSubmissions.length)} of {contactUsSubmissions.length} records
          </div>
