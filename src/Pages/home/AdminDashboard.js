...
const AdminDashboard = () => {
  ...
  const CHART_COLORS = {
    students: "#F49342", // tailwind green-500
    tutors: "#57AD85", // tailwind amber-500
    sales: "#4071B6", // tailwind indigo-500
  }
  const CHART_COLORS2 = {
    courses: "#33A752", // tailwind indigo-500
    students: "#4184F3", // tailwind green-500
    tutors: "#F49342", // tailwind amber-500
    contact: "#E94234", // tailwind rose-500
  }
  ...
  return (
    <TopHeadingProvider firstMessage={`Welcome ${userDetails?.name || "User"}`} secondMessage="Good Morning">
      <div className="flex-1 p-6 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3  mb-6 items-stretch">
          {/* Company Overview - 4 Statistics Cards in 2x2 grid */}
          <div className="lg:col-span-2 flex flex-col">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 flex-1">
              {/* Total Students Card */}
              <div className="bg-white rounded-[10px] border-1 border-[#A2A1A833] w-[313px] h-[154px]">
              ...
              {/* Total Tutors Card */}
              <div className="bg-white rounded-[10px] border-1 border-[#A2A1A833] w-[313px] h-[154px] -ml-2">
                <div className="flex pt-4 p-3 pb-0 items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 text-gray-600 text-sm mb-2">
                ...
                <div className="flex pt-4 p-3 pb-0 items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 text-gray-600 text-sm mb-2">
                      ...
                      <span className="text-[16px] font-light mb-1 text-[#16151C] w-44">Active Student/Tutors</span>
                    </div>
                  ...
                  <div className="text-right flex flex-col items-end">
                    ...
                    <div className="text-[12px] font-light text-[#A2A1A8] -ml-5 w-20 mt-2">vs last month</div>
                  </div>
                </div>
                <div className="flex items-center text-[12px] p-3 pt-2 font-light text-[#A2A1A8] border-t border-[#A2A1A833] h-[40px]">
                  Update: Aug 10, 2025
          ...
          <div className="bg-white rounded-lg -ml-2 p-3 border border-gray-200 flex flex-col h-[328px]">
            <h3 className="text-[20px] text-[#16151C] font-semibold mb-4">Totals Forms (250)</h3>
            ...
            <div className="flex items-center gap-4 mb-4 flex-1">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      outerRadius={50}   // thicker slices
                      stroke="transparent"
                      paddingAngle={1.5} // slightly smaller gap
                    ...
                    >
                      {totalsFormsData.map((entry) => (
                        <Cell
                          ...
                          fill={
                            entry.key === "courses"
                              ? CHART_COLORS2.courses
                              : entry.key === "students"
                                ? CHART_COLORS2.students
                                : entry.key === "tutors"
                                  ? CHART_COLORS2.tutors
                                  : CHART_COLORS2.contact
                          }
                        />
                      ))}
                    </Pie>
              ...
              <div className="flex-1 space-y-2 text-[12px]">
                {totalsFormsData.map((item) => (
                  <div key={item.key} className="flex items-center justify-between gap-y-2">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full" style={{ background: CHART_COLORS2[item.key] }}></div>
                      <span className="font-light text-[#16151C] text-[12px]">{item.name}</span>
                    </div>
            ...
            <div className="grid grid-cols-2 gap-1 mt-auto">
              <div className="border-1 border-[#A2A1A833] rounded-lg p-0 w-[150px] h-[52px]">
                <div className="font-light text-[14px] text-center">Total Pending Forms</div>
                <div className="text-[16px] font-semibold ml-2">204</div>
              </div>
              <div className="border-1 border-[#A2A1A833] rounded-lg p-0 w-[160px] h-[52px] ">
                <div className="font-light text-[14px] text-center">Total Processed Forms</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          {/* Credits Sold Chart */}
          <div className="lg:col-span-2 h-[358px] w-[644px] bg-white rounded-lg border border-gray-100">
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h3 className="text-[20px] font-semibold">Credits Sold</h3>
              <select className="text-sm cursor-pointer rounded px-3 py-1">
          ...
          {/* Recent Activity */}
          <div className="bg-white rounded-lg -ml-6 p-6 border border-gray-100">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
            ...
            <div className="flex items-center gap-4 text-sm">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full" style={{ background: CHART_COLORS.tutors }}></div>
                <span className="text-gray-700">Tutors Joined</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full" style={{ background: CHART_COLORS.students }}></div>
                <span className="text-gray-700">Student Joined</span>
              </div>
            </div>
          </div>
